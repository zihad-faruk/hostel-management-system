...
if(student_logged_in() || stuff_logged_in()){
    ...
    if(isset($_POST['title']) && isset($_POST['content'])) {
       ...
       if(!empty($title) && !empty($content)){
           if ($title<51 || $content<500 ) {



               $s = "INSERT INTO `complain` VALUES('','$ssn','$name','$pos','$title','$content','$date') ";
               if ($q = mysqli_query($con, $s)) {

                  if(student_logged_in()){
                      header("Location: student_profile.php?msg=".rawurlencode("Complain was successfully sent."));
                  }elseif(stuff_logged_in()){
                       header("Location: stuff_profile.php?msg=".rawurlencode("Complain was successfully sent."));
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Create Complain | Begum Sufia Kamal Hall</title>
...
<div class="col-lg-2"  style="padding-top:20px">
    <a href="home.php">Home<i class="fa fa-angle-double-right fa-5x"></i></a>
</div>
<div class="col-lg-2">
...
<div class="row">
    <div class="col-lg-3">
        ...
        <div class="contact-form col-lg-6 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
            <form id="contact-form" method="post" action="create_complain.php" style="text-align:center">

                <div class="form-group">
                    <input type="text" placeholder="Title of the complain" class="form-control" name="title" id="name">
                </div>
                ...
                <div class="form-group">
                    <textarea maxlength="500" rows="6" placeholder="Content of the complain" class="form-control" name="content" id="message"></textarea>
<span id='remainingC' style="color:green;font-weight:900"></span>
                ...
                $('textarea').keypress(function(){
                    ...
                    if(this.value.length > 500){
                        alert("Number of characters exceeded their limit");
                        return false;
                    }
