...
if (!empty($email) && !empty($pass)) {
    ...
    $query = "SELECT `ASSN` FROM `admin` WHERE `Email`='".mysqli_real_escape_string($con,$email)."' AND `Password`='".mysqli_real_escape_string($con,$pass_hash)."'";
...
<div class="row">
    ...
    <a href="editor_login.php"><button type="button" name="button" class="btn btn-primary" style="color:grey;font-weight: 600;float:right;margin-right:70px;margin-top:20px"> <i class="fa fa-edit"></i>  Editor Login</button></a>
</div>

<!--Form Title--->
<div class="title text-center wow fadeIn" data-wow-duration="500ms" style="text-align: center;margin-top: 27vh">
    <h2>Admin  <span class="color">Log In</span> Page</h2>
        ...
        <div class="contact-form col-md-6 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
            <form id="contact-form" method="GET" action="">
               ...
               <div style="text-align: center">
                   <a href="stuff_login.php" style="margin: 0 auto;text-align: center">Are you a stuff? Sign in here</a>
               </div>
