    ...
    if(strlen($pass)>=6){
        ...
        <?php }
            ...
            if(strlen($fname)>32 || strlen($lname)>32){ ?>
                ...
                $query = "INSERT INTO `stuff` VALUES ('$sid','$fname','$lname','$sdept','','$adrs','$scno','$email','$pass_hash','')";

                if($query_run = mysqli_query($con,$query)){
                    header("Location: stuff_login.php?m=".rawurlencode(" You can now log in."));
...
<!--For validating form and submitting the data-->
...
<div class="title text-center wow fadeIn" data-wow-duration="500ms" style="text-align: center;margin-top: 40vh">
    ...
    <div class=""  style="padding:20px;font-size:20px">
        <a href="stuff_login.php">Already a registered? Sign in</a>
    </div>
</div>
...
<form id="regForm" action="stuff_reg.php" method="POST" style="margin-top:40vh">



  <!-- One "tab" for each step in the form: -->
  <div class="tab"><h1 style="font-weight: 600">Stuff <span class="color">Name</span></h1>
  ...
  <div class="tab"><h1 style="font-weight: 600">Stuff <span class="color">Information</span></h1>
      <p><input type="number" min="11000000" placeholder="Your Social Security Number" oninput="this.className = ''" name="sid"></p>
      <p>Position</p> <select name="sdept">
