...
<body>
    <div class="row">
        ...
        <a href="student_reg.php"><button type="button" name="button" class="btn btn-primary" style="float:right;margin-right:70px;margin-top:20px"> <i class="fa fa-pencil"></i>  Register</button></a>
    </div>
<!--Form Title--->
<div class="title text-center wow fadeIn" data-wow-duration="500ms" style="text-align: center;margin-top: 30vh">
    <h2>Student  <span class="color">Log In</span> Page</h2>
...
if (!empty($email) && !empty($pass)) {
    ...
    $query = "SELECT `Student_id` FROM `student` WHERE `Email`='".mysqli_real_escape_string($con,$email)."' AND `Password`='".mysqli_real_escape_string($con,$pass_hash)."'";
        ...
        <div class="contact-form col-md-6 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
            <form id="contact-form" method="GET" action="">
                ...
                <div class="" style="text-align:center">
                    <a href="student_reg.php">Not yet registered ? Register here</a>
                </div>
            </form>
        <div class="col-md-3"></div>
    </div>
